...
pub fn routes() -> Router<AppState> {
     Router::new()
        ...
        .route( "/orders/{order_id}",get(orders::get_order_handler).put(orders::update_order_handler).delete(orders::delete_order_handler))
        ...
        .route("/products",  get(products::list_products_handler).post(products::create_product_handler))
        .route("/products/{product_id}", put(products::update_product_handler))
        .route("/products/{product_id}/off-shelf",  post(products::off_shelf_product_handler) )
